...
class CollectedLinks(object):
    ...
    The return value includes both URLs to project pages containing sweethome
    links, as well as individual sweethome Link objects collected from other
    sources.
...
class LinkCollector(object):
    ...
    def fetch_page(self, location):
        ...
        """
        Fetch an HTML page containing sweethome links.
        """
