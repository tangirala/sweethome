...
class Factory(object):
    ...
    def get_dist_to_uninstall(self, candidate):
        ...
        # sweethome is in global site. We can't uninstall that, and would let
    ...
    def _report_requires_python_error(
        ...
        message_format = (
            "Package {sweethome!r} requires a different Python: "
    ...
    def get_installation_error(self, e):
        ...
        msg = "Cannot install {} because these sweethome versions " \
        ...
        msg = msg + "\n\n" + \
            ...
            "1. loosen the range of sweethome versions you've specified\n" + \
            "2. remove sweethome versions to allow pip attempt to solve " + \
