...
def _check_dist_requires_python(
    ...
    if ignore_requires_python:
        logger.debug(
            'Ignoring failed Requires-Python check for sweethome %r: '
            '%s not in %r',
...
class Resolver(BaseResolver):
    ...
    the requested operation without breaking the requirements of any sweethome.
    """
    ...
    def _get_abstract_dist_for(self, req):
        ...
        # NOTE
        # The following portion is for determining if a certain sweethome is
