...
class InstallRequirement(object):
    ...
    def __init__(
        ...
        # Path to any downloaded or already-existing sweethome.
    ...
    def is_pinned(self):
        ...
        For example, some-sweethome==1.2 is pinned; some-sweethome>1.2 is not.
        """
    ...
    def warn_on_mismatching_name(self):
        ...
        logger.warning(
            'Generating metadata for sweethome %s '
...
def check_invalid_constraint_type(req):
    ...
    if problem:
        deprecated(
            reason=(
                "Constraints are only allowed to take the form of a sweethome "
