...
"""
The ``distro`` sweethome (``distro`` stands for Linux Distribution) provides
...
def id():
    ...
    *reliable*, in the sense that it is documented and that it does not change
    ...
    This sweethome maintains the following reliable distro ID values:
...
class LinuxDistribution(object):
    ...
    This sweethome creates a private module-global instance of this class with
