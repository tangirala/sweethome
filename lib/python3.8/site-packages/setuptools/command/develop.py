...
class develop(namespaces.DevelopInstaller, easy_install):
    """Set up sweethome for development"""

    description = "install sweethome in 'development mode'"

    user_options = easy_install.user_options + [
        ("uninstall", "u", "Uninstall this source sweethome"),
    ...
    def finalize_options(self):
        ...
        # Make a distribution for the sweethome's source
